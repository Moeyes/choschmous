...
import type { DashboardProvince, DashboardParticipant } from "@/src/features/dashboard/types/types"

function calcProvinces(participants: DashboardParticipant[]): DashboardProvince[] {
  ...
  return Object.values(provinces).sort((a, b) => b.participants - a.participants)
}
