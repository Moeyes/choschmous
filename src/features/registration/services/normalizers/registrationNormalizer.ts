...
import { slug, ensureStringArray } from '@/src/lib/utils'

export { ensureStringArray as ensureArrayOfStrings }
...
export function normalizeRegistration(body: ExtendedFormData): NormalizedRegistration {
  const sports = ensureStringArray(body.sports ?? (body.sport ? [body.sport] : []))
  ...
  const baseResult: NormalizedRegistration = {
    fullNameKhmer: body.fullNameKhmer ?? null,
    fullNameEnglish: body.fullNameEnglish ?? null,
