...
import { ParticipantDetailDialog } from "../participants/ParticipantDetailDialog";
import { ParticipantEditDialog } from "../participants/ParticipantEditDialog";
import {
  SearchInput,
  FilterDropdown,
  StatusBadge,
...
export function AthletesSection({
  ...
  const filteredList = useMemo(() => {
    return list.filter((athlete) => {
      ...
      const matchesStatus =
        statusFilter === "all" ||
        athlete.status?.toLowerCase() === statusFilter.toLowerCase();
    ...
    <div className="space-y-6">
      ...
      <Card className="border-none shadow-sm rounded-2xl p-6 space-y-6">
        ...
        <div className="space-y-4">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <Badge
                      variant="outline"
                      className="bg-blue-50 text-blue-600 border-blue-200 rounded-md text-[10px] px-2 py-0.5"
                    >
                      កីឡា
                    </Badge>
          ...
          {filteredList.length === 0 && <EmptyState type="participants" />}
        </div>
      </Card>
